//Finish merging
/**
 * Abstract base class for Vision types.
 */
public abstract class Vision {
    ...
    /**
     * Kept from Week 1 MVP placeholder to ensure Brain.java still compiles safely today.
     * Specific subclasses (like CautiousVision) can override this later.
     */
    public String evaluateNeeds() {
        Log.methodStart("Vision", "evaluateNeeds", "none");
        Log.methodEnd("Vision", "evaluateNeeds", "EAST");
        return "EAST"; 
    }
    ...
    // Loops through all visible directions, finds the first square with a FoodBonus,
    ...
    // Loops through all visible directions, finds the first square with a WaterBonus,
    // and returns a Path to it. Returns null if none found.
    ...
    // Loops through all visible directions, finds the first square with a GoldBonus,
    // and returns a Path to it. Returns null if none found.
